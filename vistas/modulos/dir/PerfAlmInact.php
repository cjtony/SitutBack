...
?>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<a class="btn bg-white text-primary cardShadow mr-3 btn-md" href="AlmInact.php">
			...
			<div class="col-md-8 col-lg-9">
				...
				<div class="row mt-4">
					...
					<div class="col-sm-6 text-center">
						...
						?>
							<img src="<?php echo $urlFront;?>modAlm/Arch/perfil/<?php echo $datAlm->foto_perf_alm ?>" class="img-fluid img-thumbnail rounded" width="200">
						<?php
				...
				<div class="row mt-5">
					<div class="col-sm-4 text-center">
						<button id="btnDatGrp" class="btn bg-white text-primary cardShadow btn-md" onclick="mostDatGrp(true),mostJustif(false), mostDatPer(false)">
							<i class="fas fa-users fa-lg icoIni"></i>
							Grupo <?php echo $datAlm->grupo_n; ?>
						</button>
					</div>
					<div class="col-sm-4 text-center">
						<button id="btnJustif" class="btn bg-white text-primary cardShadow btn-md" onclick="mostJustif(true), mostDatPer(false), mostDatGrp(false)">
							<i class="fas fa-file-alt fa-lg icoIni"></i>
							Justificantes
						</button>
					</div>
					<div class="col-sm-4 text-center">
						<button id="btnDatPer" class="btn bg-white text-primary cardShadow btn-md" onclick="mostDatPer(true), mostJustif(false), mostDatGrp(false)">
							<i class="fas fa-book fa-lg icoIni"></i>
							Datos personales
						</button>
					</div>
					<!-- <div class="col-sm-3 text-center">
						<button id="btnDatPer" class="btn bg-white text-success cardShadow btn-lg" onclick="mostDatPer(false), mostJustif(false), mostDatGrp(false)">
