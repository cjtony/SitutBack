   					...
   					<ul class="navbar-nav">
      					...
      					<li class="nav-item dropdown text-center border rounded" style="margin-right: 5px;">
		        			<a style="font-size: 18px; padding: 10px;" class="hovLinkNav nav-link dropdown-toggle btn-light rounded" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		        				...
		        				<span class="badge badge-success font-weight-normal" style="padding: 5px; font-size: 17px;">Director : </span>
		         				<?php echo $datDirec->nombre_c_dir; ?>
		        			</a>
		        			<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
		          				<a data-backdrop="false" data-toggle="modal" data-target="#confContDir" class="dropdown-item aNav" href="#"> 
		          					<i class="fas fa-key fa-lg icoIni"></i> 
		          					Cambiar contraseña
		          				</a>
		          				<div class="dropdown-divider"></div>
		          				<a data-backdrop="false" data-toggle="modal" data-target="#confDatDir" class="dropdown-item aNav" href="#">
		      			...
		      			<li class="nav-item text-center border rounded" style="margin-right: 5px;">
					        <a style="font-size: 18px; padding: 10px;" class="hovLinkNav nav-link btn-light text-danger rounded" href="../vistas/modulos/dir/Logout.php">
					        	Salir
