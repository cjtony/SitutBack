		...
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-4 pad30 animated fadeInRight delay-1s">
				...
				<div class="cardShadow pad30 text-center cardBg">
					<h6>Cuentas Activas = <span class="badge badge-pill font-weight-normal bg-primary text-white" id="admAct">Cargando...</span></h6>
					<h6>Cuentas Inactivas = <span class="badge badge-pill font-weight-normal bg-danger text-white" id="admInc">Cargando...</span></h6>
				</div>
				<br>
