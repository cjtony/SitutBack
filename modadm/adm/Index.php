		...
		<div class="col-sm-12">
			...
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-5 text-center">
					<br>
					<img src="<?php echo SERVERURL; ?>vistas/img/icous.png" width="300" alt="" class="img-fluid">
				</div>
					...
					<div class="row">
						<div class="col-sm-6 col-md-6 col-lg-6">
							<div class="card cardShadow bg-white text-primary mb-3 text-center rounded" style="max-width: 18rem;">
					  			...
					  			<div class="card-body">
					  				...
					  				?>
										<a href='<?php echo SERVERURLADM; ?>DetAdmin/' class='btn btn-outline-primary btn-md'> <i class='fas fa-plus icoIni'></i> Detalles </a>
					  				<?php
						...
						<div class="col-sm-6 col-md-6 col-lg-6">
							<div class="card cardShadow bg-white text-primary mb-3 text-center rounded" style="max-width: 18rem;">
							  	...
							  	<div class="card-body">
							  		<a href="<?php echo SERVERURLADM; ?>DetCarreras/" class="btn btn-outline-primary btn-md"> <i class="fas fa-plus icoIni"></i> Detalles </a>
							  	</div>
							</div>
						</div>
						<div class="col-sm-6 col-md-6 col-lg-6">
							<div class="card cardShadow bg-white text-primary mb-3 text-center rounded" style="max-width: 18rem;">
							  	...
							  	<div class="card-body">
							  		<a href="<?php echo SERVERURLADM; ?>DetDirectores/" class="btn btn-outline-primary btn-md"> <i class="fas fa-plus icoIni"></i> Detalles </a>
							  	</div>
							</div>
						</div>
						<div class="col-sm-6 col-md-6 col-lg-6">
							<div class="card cardShadow bg-white text-primary mb-3 text-center rounded" style="max-width: 18rem;">
							  	...
							  	<div class="card-body">
							  		<a href="<?php echo SERVERURLADM; ?>DetCoord/" class="btn btn-outline-primary btn-md"> <i class="fas fa-plus icoIni"></i> Detalles </a>
							  	</div>
							</div>
						</div>
					</div>	
