<?php 
  ...
  $valTip = $cod[2];
	$datDirect = $director -> dataDirectSel($valDat);
  $datDocent = $director -> dataDocentSel($valDat);
  $datCoordi = $director -> dataCordinSel($valDat);
?>
...
<div class="container-fluid">
    ...
    <div class="col-sm-12">
      <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h4 class="m-0 font-weight-bold text-primary">
                    Datos del docente: <b><?php echo $datDocent->nombre_c_doc; ?></b>.
                  </h4>
                </div>
                <div class="card-body">
                  <div class="text-center">
                  ...
                  <div class="row text-center mt-3">
                    <div class="col-sm-4 text-truncate">
                      <i class="fas fa-university mr-1"></i>
                      <?php echo $datDocent->especialidad_doc; ?>
                    </div>
                    <div class="col-sm-4">
                      <i class="fas fa-envelope mr-1"></i>
                      <?php echo $datDocent->correo_doc; ?>
                    </div>
                    <div class="col-sm-4">
                      <i class="fas fa-phone mr-1"></i>
                      <?php echo $datDocent->telefono_doc; ?>
                    </div>
                  </div>
                </div>
              </div>
